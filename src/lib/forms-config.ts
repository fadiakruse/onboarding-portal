...
export const FORMS: FormConfig[] = [
  ...
  { id: '02-w4-2026', order: 2, title: "Form W-4 (2026) — Employee's Withholding Certificate", shortTitle: 'W-4 (2026)',
    intro: ['Complete the official IRS Form W-4 below using your browser\u2019s PDF tools (click into a field to type), covering Steps 1\u20135. Then save/download the completed PDF and upload it here.'],
    embeddedOfficialPdf: { key: 'w4', uploadFieldId: 'completedW4File', label: 'Upload your completed W-4 PDF' },
    fields: [{ id: 'completedW4File', label: 'Upload your completed W-4 PDF', type: 'fileUpload', accept: 'application/pdf', required: true }],
    requiresSignature: true },
